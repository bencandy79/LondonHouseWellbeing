...
def importSchools():
    # from https://get-information-schools.service.gov.uk/Downloads
    CSV_SCHOOLS = 'http://ea-edubase-api-prod.azurewebsites.net/edubase/edubasealldata20180908.csv'
    try:
    ...
    df_schoolslondonopen = df_schoolsall[(df_schoolsall['EstablishmentStatus (code)'] == 1)]
